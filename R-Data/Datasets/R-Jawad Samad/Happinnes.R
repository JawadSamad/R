...
#--------------------------------------------------------------------------------------------#
#2018 - Visualisation
#Created a scatterplot which outputs the overall scores and the GDP. (Figuur 1) 
...
#Created a histrogram which outputs the scores of the dataset. (Figuur 3) 
...
#Created a barplot, functions as a heatmap to see if the life expectancy is better if a country has a higher GDP. (Figuur 5)
...
#--------------------------------------------------------------------------------------------#
#2019 - Visualisation
#Created a scatterplot which outputs the overall scores and the GDP. (Figuur 2) 
...
#Created a histrogram which outputs the scores of the dataset. (Figuur 4)
...
#Created a barplot, functions as a heatmap to see if the life expectancy is better if a country has a higher GDP. (Figuur 6)
